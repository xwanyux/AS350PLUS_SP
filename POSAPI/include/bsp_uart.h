...
typedef struct BSP_UART_S
{
   ...
   UINT32   			      	ParityErrors;
	...
	/*
	 * Linux device file description.Variable to store open() return value,used as dhn.
	 */
	UINT16						Fd;
...
extern BSP_UART * BSP_UART_Acquire( UINT8 UartNum, UART_ISR_FUNC pIsr );
...
extern UINT8 BSP_UART_SendAck( UINT8 dhn, UINT8 acknum);
